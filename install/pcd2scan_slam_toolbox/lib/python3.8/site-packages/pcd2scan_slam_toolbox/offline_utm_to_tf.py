...
class UTMToTF(Node):
    ...
    def imu_callback(self, msg: Imu):
        ...
        self.yaw = yaw  # 只存，不发 TF，等有 gps 的时间戳再发
    ...
    def gps_callback(self, msg: NavSatFix):
        ...
        # 2) 组 TF，注意时间用 GPS 的时间
        t = TransformStamped()
        t.header.stamp = msg.header.stamp          # ★ 关键：用消息时间
        ...
        self.get_logger().info(f'pub TF at {msg.header.stamp.sec}.{msg.header.stamp.nanosec} x={x:.3f} y={y:.3f}')
